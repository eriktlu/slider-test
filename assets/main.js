...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-up', speed: 1000, intensity: 2, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-in', speed: 250, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.image.style6', { style: 'zoom-out-image', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('#container27', { style: 'fade-in-background', speed: 625, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#text107', { style: 'fade-down', speed: 1000, intensity: 2, delay: 0, staggerOrder: '', replay: false });
